...
calibrateCounter = 0
fitted = 0
gClassifier = KNeighborsClassifier(n_neighbors=5)
...
train_test_model()
dump(gClassifier, 'knnClassifierFromVideo.joblib') 
dump(poly, 'knnPolynomialFeaturesFromVideo.joblib') 
dump(scaler, 'knnStandardScalerFromVideo.joblib')
